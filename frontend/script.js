...
const MISTRAL_API_KEY = "rmqldypehDBc5QTkfhncf6HAcQ5oxKVo"; // <-- configured (paste a new key here to rotate)
...
async function generateAiRecipes() {
  ...
  if (MISTRAL_API_KEY === "YOUR_API_KEY_HERE") {
    status.textContent = "Add your Mistral API key to script.js (MISTRAL_API_KEY) to unlock AI recipes.";
    return;
  }
