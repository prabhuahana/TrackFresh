...
/*  Google Custom Search AI recipe suggester 
   Searches Google for real recipes matching your on-hand inventory.
   Get a key at https://console.cloud.google.com/apis/credentials and a
   Custom Search Engine ID at https://cse.google.com/cse/all (set it to
   search recipe sites like allrecipes.com, food.com, etc.).
*/
const GOOGLE_API_KEY = "AIzaSyBOOoC-XDg5tBzhO17Qg1oY3k2wPy3w_ik";  
const GOOGLE_SEARCH_CX = "a4ef87db550d547bd";          
const GOOGLE_API_URL = "https://www.googleapis.com/customsearch/v1";

let _aiRunning = false;  // re-entrancy guard
...
async function generateAiRecipes() {
  ...
  if (GOOGLE_API_KEY === "YOUR_GOOGLE_API_KEY_HERE" || GOOGLE_SEARCH_CX === "YOUR_CSE_ID_HERE") {
    status.textContent = "Paste your Google API key + CSE ID into script.js to unlock AI recipes.";
    return;
  }
